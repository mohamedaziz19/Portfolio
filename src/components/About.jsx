  ...
  return (
    ...
    >
      ...
      >
        ...
        mb-4 sm:mb-6 text-transparent bg-linear-to-r from-orange-400
        to-orange-600 bg-clip-text"
          ...
          <p
            ...
            data-aos-delay="500"
          >
            I'm a Frontend Developer who loves building clean and modern web
            applications. I also have a good background in backend development,
            which helps me understand the full picture of how web apps work.
          ...
          <button
            className={`w-full sm:w-auto inline-flex items-center justify-center
                   border-2 border-orange-500 py-2 px-4 sm:px-6 
                   hover:shadow-[0_0_40px_rgb(255,165,0,0.7)] rounded-full text-base 

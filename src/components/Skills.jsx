...
import framer_motion from "../assets/framer_motion.webp";
      ...
      <div className="py-14 relative overflow-hidden">
        <div className="container px-5 py-14 mx-auto ">
          ...
          >
            ...
            >
              Building clean, responsive front-end apps with React & Tailwind,
              backed by solid backend knowledge. Always learning, always
              improving
            </p>
          </div>
          ...
          >
            {skills.map((skill, index) => (
              <div
                key={index}
                className="p-4 lg:w-1/4 md:w1/2 w-full"
                data-aos="fade-up"
              ...
              >
                <div
                  style={{
                    background: darkMode
                      ? "linear-gradient(to bottom right , #1f29370 ,#1118227)"

  ...
  return (
    <div className=" flex justify-center w-full fixed z-50 mt-4">
      <motion.nav
        ...
        backdrop-blur-lg rounded 2xl px-4 lg:px-8 py-2 shadow`}
      >
          ...
          <div className="flex items-center space-x-2">
            ...
            <motion.button
              ...
              className={`p-2 rounded-full 
                ${darkMode ? "bg-gray-700" : "bg-gray-200"} transition-colors`}
              aria-label={
            ...
            <motion.a
              ...
              className={` hidden lg:block px-6 py-2 font-semibold
                  rounded-full bg-linear-to-r ${colors.button} text-white shadow-lg transition-shadow
        ...
        {isMenuOpen && (
          ...
          ${darkMode ? 'bg-gray-900/95' : 'bg-white/95'} backdrop-blur-lg rounded-xl shadow-lg
